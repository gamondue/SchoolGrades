...
SchoolGrades is written in C# with Windows Forms, currently in .Net 9.

SchoolGrades currently has no documentation. Contribution to documentation and questions about the use of the program are welcomed and encouraged.

The SchoolGrades' user interface is totally in Italian.  
The source code of the program is entirely in English.  
So, if anyone would like to be involved in the translation into English or another language, please tell it. We can arrange a way to do it ..
